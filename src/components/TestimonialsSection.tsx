    ...
    <section ref={sectionRef} className="py-16 sm:py-20 bg-slate-100/90 text-slate-900 relative overflow-hidden border-b border-slate-300/80">
      <div className="max-w-[1520px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12 space-y-3">
          ...
          <p className="testimonials-header-anim text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              <div className="mt-6 pt-5 border-t border-slate-200/70 flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  <img
                    src={item.avatar}
                    alt={item.name}
                    className="w-12 h-12 rounded-full object-cover border-2 border-indigo-600 shrink-0 shadow-xs"
                  />
                  <div className="min-w-0 flex-1">
                    <h4 className="text-sm sm:text-base font-bold text-slate-900 font-['Outfit'] truncate">
                      {item.name}
                    </h4>
